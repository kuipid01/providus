...
const MessageWrapper = ({ children, name, position }: TestimonialCardProp) => {
  return (
    <div className="w-full lg:w-[606px]  shrink-0">
      <div className=" relative shrink-0 w-full  lg:w-[606px] py-7 lg:py-12 px-6 lg:px-13 ">
        <img
          src="/assets/Bubble.png"
          className="shrink-0 z-0 h-[266px] absolute inset-0 w-full lg:w-[606px]"
          alt=" bubble"
        />
